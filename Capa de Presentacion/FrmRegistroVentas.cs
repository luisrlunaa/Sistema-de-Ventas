...
namespace Capa_de_Presentacion
{
    public partial class FrmRegistroVentas : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void FrmVentas_Activated(object sender, EventArgs e)
        {
            ...
            txtdireccion.Text = string.IsNullOrWhiteSpace(txtdireccion.Text) ? Program.Direccion : txtdireccion.Text;
        ...
        private void chkComprobante_CheckedChanged(object sender, EventArgs e)
        {
            if (chkComprobante.Checked)
            {
                txtrcnClient.Show();
                lblrcnClient.Show();
                txtrcnClient.Text = string.Empty;
            }
            else
            {
                txtrcnClient.Hide();
                lblrcnClient.Hide();
                txtrcnClient.Text = string.IsNullOrWhiteSpace(txtrcnClient.Text) ? "sin rcn del Cliente" : txtrcnClient.Text;
                txtNCF.Text = string.IsNullOrWhiteSpace(txtNCF.Text) ? "Sin NCF" : txtNCF.Text;
                combo_tipo_NCF.Text = string.IsNullOrWhiteSpace(combo_tipo_NCF.Text) ? "Ningun Tipo de Comprobante" : combo_tipo_NCF.Text;
            }
        }
