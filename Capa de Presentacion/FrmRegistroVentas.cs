...
namespace Capa_de_Presentacion
{
    public partial class FrmRegistroVentas : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void btnSalir_Click(object sender, EventArgs e)
        {
            ...
            if (!chkComprobante.Checked && !string.IsNullOrEmpty(txtNCF.Text))
            {
            ...
            if (!cbidentificacion.Checked && Program.IdCliente == 0)
            {
                if (string.IsNullOrWhiteSpace(Program.datoscliente) && !string.IsNullOrWhiteSpace(txtDatos.Text))
                {
                    Program.datoscliente = txtDatos.Text;
        ...
        public void VentaRealizada(bool fuicotizacion)
        {
            ...
            using (SqlCommand cmd = new SqlCommand(procedure, M.conexion))
            {
                ...
                cmd.Parameters.Add("@Vehiculo", SqlDbType.VarChar).Value = "sin Vehiculo";
        ...
        private void To_pdf()
        {
            ...
            saveFileDialog1.FileName = "Venta" + DateTime.Now.ToString("ddMMyyyyHHmmss");
